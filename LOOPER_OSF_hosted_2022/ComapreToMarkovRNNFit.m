...
SAVE_FILE = 'BayesoptResultsRNN.mat';
...
fun = @(x)ComapreToMarkovRNNFunction(x.pcCount, x.epsilon, x.t, x.k, x.stateCounts);
% ComapreToMarkovRNNFunction(10, 20, 10, 10, 50)
